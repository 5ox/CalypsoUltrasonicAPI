...
public b4a.example.broadcastreceiverservice _broadcastreceiverservice = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 56;BA.debugLine="Activity.LoadLayout(\"MainActivity\")";
mostCurrent._activity.LoadLayout("MainActivity",mostCurrent.activityBA);
 //BA.debugLineNum = 57;BA.debugLine="Activity.Title = \"Calypso Ultrasonic API\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Calypso Ultrasonic API"));
 //BA.debugLineNum = 59;BA.debugLine="ctr = 0";
_ctr = (int) (0);
 //BA.debugLineNum = 60;BA.debugLine="lblTitle.Text = \"Calypso Ultrasonic API\"";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 76;BA.debugLine="uiTimer.Enabled = False";
_uitimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 77;BA.debugLine="If UserClosed Then";
if (_userclosed) { 
 //BA.debugLineNum = 78;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 };
 //BA.debugLineNum = 81;BA.debugLine="StopService(BroadcastReceiverService)";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(mostCurrent._broadcastreceiverservice.getObject()));
 //BA.debugLineNum = 83;BA.debugLine="If UserClosed Then Activity.Finish";
if (_userclosed) { 
mostCurrent._activity.Finish();};
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 65;BA.debugLine="uiTimer.Initialize(\"uiTimer\", 1000)";
_uitimer.Initialize(processBA,"uiTimer",(long) (1000));
 //BA.debugLineNum = 66;BA.debugLine="uiTimer.Enabled = True";
_uitimer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 68;BA.debugLine="Log(\"Initialized the timers.. \")";
anywheresoftware.b4a.keywords.Common.Log("Initialized the timers.. ");
 //BA.debugLineNum = 70;BA.debugLine="StartService(BroadcastReceiverService)		' start B";
anywheresoftware.b4a.keywords.Common.StartService(processBA,(Object)(mostCurrent._broadcastreceiverservice.getObject()));
 //BA.debugLineNum = 73;BA.debugLine="End Sub";
return "";
}
public static String  _globals() throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub Globals";
 //BA.debugLineNum = 49;BA.debugLine="Public lblTitle As Label";
mostCurrent._lbltitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 50;BA.debugLine="Public ListView1 As ListView";
...
broadcastreceiverservice._process_globals();
...
_uitimer = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 43;BA.debugLine="Public ctr As Int";
_ctr = 0;
 //BA.debugLineNum = 44;BA.debugLine="End Sub";
return "";
}
public static String  _uitimer_tick() throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub uiTimer_Tick";
 //BA.debugLineNum = 88;BA.debugLine="ctr = ctr + 1";
_ctr = (int) (_ctr+1);
